...
/**
 * Servlet implementation class DeleteGiftRequestServlet
 */
@WebServlet("/delete/gift_request")
public class DeleteGiftRequestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteGiftRequestServlet() {
        super();
		...
		if (session.getAttribute("userId") == null || session.getAttribute("password") == null) {
			...
			if (exist_management) {
				...
				try {
					...
					// MHGMから削除
					String sql1 = "DELETE FROM MHGM WHERE GIFTID=?";
					pstmt1 = conn.prepareStatement(sql1);
					pstmt1.setString(1, GIFTID);
					pstmt1.executeUpdate();
					
					// MHSEから削除
					String sql2 = "DELETE FROM MHSE WHERE GIFTID=?";
					pstmt2 = conn.prepareStatement(sql2);
					pstmt2.setString(1, GIFTID);
